        ...
        result = {
            ...
            'mars_rubric': {
                ...
                'content_subscores': {
                    ...
                    'content_before_penalty': round(float(_content_detail.get('content_category_score_before_penalty', mars_content_score) or 0), 2),
                    'content_context_misalignment_penalty_points': round(float(_content_detail.get('content_context_misalignment_penalty_points', 0) or 0), 2),
                    'context_alignment_score': pedagogical_analysis.get('context_alignment_score'),
                    'context_alignment_verdict': pedagogical_analysis.get('context_alignment_verdict'),
